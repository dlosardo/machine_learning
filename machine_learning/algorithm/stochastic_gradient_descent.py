...
class StochasticGradientDescent(GradientDescent):
    def __init__(self, cost_function, learning_rate, tolerance=None,
        ...
        super(StochasticGradientDescent, self).__init__(
            cost_function, learning_rate=learning_rate, tolerance=tolerance,
            param_starting_values=param_starting_values)
    ...
    def iterate(self):
        ...
        for i in range(0, self.nobs):
            updated_params = (self.get_parameters() +
                              self.learning_rate*self.cost_function.
                              cost_function_derivative(i))
