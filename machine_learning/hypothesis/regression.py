...
parameters are intercept and nx slopes, where nx is the
number of features (independent variables) of the form:
    (nx + 1) x 1
...
class Regression(Hypothesis):
    ...
    def __init__(self, features):
        ...
        # self.features becomes a matrix of dimension
        # nobs x nx with the first column
    ...
    def set_parameters(self):
        ...
        intercept = Parameter(name="intercept", value=None,
